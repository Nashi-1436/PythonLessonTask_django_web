...
try:
    ...
    # 插入网站root管理员
    from app01.models import Admin  # 导入Admin模型
    ...
    if created:
        ...
        # 更新密码（假设您要更新密码）
        new_password = 'new_password_secret'  # 新密码
        admin_instance.password = make_password(new_password)
        admin_instance.save()
        print('网站 root 管理密码已更新')

    print('网站 root管理 账户: '+root_user+"  密码: "+root_password)    
